...
public class QuoteService implements QuoteServiceImpl {
  ...
  private QuoteReqDto getPrice(String symbol) throws FinnhubException, invalidInputException {
  ...
  @Override
  public QuoteReqDto getCompanyPrice(String symbol) throws FinnhubException, invalidInputException {

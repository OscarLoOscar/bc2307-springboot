...
public class CompanyServiceTest {
  ...
  void testRestTemplateUrl() throws FinnhubException {
    ...
    CompanyProfile2DTO mockCompanyProfile = CompanyProfile2DTO.builder()//
        .country("HK")//
    ...
    // test Mock link
    Mockito
        .when(restTemplate.getForObject(expectedUrl, CompanyProfile2DTO.class))//
    ...
    // 真link
    CompanyProfile2DTO profile = companyService.getCompanyProfile("TSLA");
